<div class="mt-8 rounded-3xl border border-amber-400/20 bg-gradient-to-br from-amber-500/10 via-slate-950 to-slate-950 p-6 shadow-2xl">
  <div class="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
    <div>
      <p class="text-xs font-semibold uppercase tracking-[0.2em] text-amber-300">Fear-of-Loss Monitoring</p>
      <h2 class="mt-2 text-2xl font-extrabold text-white sm:text-3xl">Positioning Risk & Sponsorship Exposure</h2>
      <p class="mt-3 max-w-3xl text-sm leading-7 text-slate-300 sm:text-base">
        Monitor members whose downline activity is moving faster than their company activation status.
        This is the priority area for identifying sponsor risk, positioning gaps, and reassignment patterns.
      </p>
    </div>
  ...
  <div class="mt-6 rounded-2xl border border-amber-300/20 bg-slate-900/60 p-4">
    <div class="flex items-start gap-3">
      <div class="mt-0.5 flex h-10 w-10 items-center justify-center rounded-xl bg-amber-500/10 text-amber-300">
      ...
      <div>
        <p class="font-semibold text-white">Warning: 127 members currently have at least one company positioning gap.</p>
        <p class="mt-1 text-sm leading-6 text-slate-300">
          Their direct or indirect downline has already joined one or more affiliated companies where those sponsors are not active.
          These cases may lead to current or future sponsorship reassignment.
        </p>
      </div>
    </div>
  </div>
