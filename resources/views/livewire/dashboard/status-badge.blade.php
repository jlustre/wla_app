@php
    $toneMap = [
        ...
        'gold' => 'bg-amber-50 text-amber-700 ring-amber-200 dark:bg-amber-500/10 dark:text-amber-300 dark:ring-amber-500/20',
...
<span class="inline-flex items-center rounded-full px-2.5 py-1 text-xs font-semibold ring-1 ring-inset {{ $toneMap[$tone] ?? $toneMap['blue'] }}">
    {{ $label }}
</span>