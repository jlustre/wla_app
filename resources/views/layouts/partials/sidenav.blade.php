...
<aside id="app-menu" class="app-menu">
    ...
    <a href="index.html"
        class="logo-box sticky top-0 flex min-h-topbar-height items-center justify-start px-6 backdrop-blur-xs">
        <!-- Light Brand Logo -->
            ...
            <ul class="side-nav p-3 hs-accordion-group">
                ...
                <li class="menu-item hs-accordion">
                    ...
                    <ul class="sub-menu hs-accordion-content hidden">
                        ...
                        <li class="menu-item">
                            <a href="layouts-sidenav-hover-active.html" target="_blank" class="menu-link">Hover Active
                                Sidenav</a>
                        </li>
                        <li class="menu-item">
                        ...
                        <li class="menu-item">
                            <a href="layouts-sidenav-offcanvas.html" target="_blank" class="menu-link">Offcanvas
                                Sidenav</a>
                        </li>
                        <li class="menu-item">
